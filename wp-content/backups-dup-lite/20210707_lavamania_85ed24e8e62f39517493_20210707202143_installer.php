...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210707_lavamania_85ed24e8e62f39517493_20210707202143_archive.zip';
	const ARCHIVE_SIZE		 = '54908054';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '85ed24e-07202143';
    const SECONDARY_PACKAGE_HASH = '75e0687-07202143';
	const VERSION			 = '1.4.1';
