...
class Subscription_Payu_Latam_SPL_Admin
{
    ...
    public function enqueue_scripts_admin()
    {
        ...
        wp_enqueue_script( 'subscription_payu_latam_spl', suscription_payu_latam_pls()->plugin_url . 'assets/js/subscription-payu-latam-config.js', array( 'jquery' ), suscription_payu_latam_pls()->version, true );
