...
if ( !function_exists('ltx_get_fa5_icons') ) {

	function ltx_get_fa5_icons() {
...
//					$class = str_replace(array('far ', 'fab '), 'fas ', $class);
					$icons[$class] = $class;
				}
			}
		}
	...
	function aqualine_fw_add_more_packs( $default_packs ) {
		...
		if ( !empty($file) ) {
			...
			$packs['aqualine_theme_icons'] = array(

				'name' => 'aqualine_theme_icons',
				'title' => 'Aqualine Theme Icons',
				'css_class_prefix' => 'icon',

				'css_file' => $file,
				'css_file_uri' => $fontello['css']['url'],

				'admin_wp_enqueue_handle' => 'aqualine-fontello',
				'frontend_wp_enqueue_handle' => 'aqualine-fontello',
		...
		$packs['aqualine_fa5_icons'] = array(
				
			'name' => 'aqualine_fa5_icons',
			'title' => 'Font Awesome 5 Free',

			'admin_wp_enqueue_handle' => 'aqualine-fontawesome-5',
			'frontend_wp_enqueue_handle' => 'aqualine-fontawesome-5',

			'require_css_file' => false,
			'icons' => false,

			'apply_root_class' => false,
			'load_icons_callback' => 'ltx_get_fa5_icons'
		);		

		return $packs;
	}

	add_filter( 'fw:option_type:icon-v2:packs', 'aqualine_fw_add_more_packs' );			

	function aqualine_fw_custom_packs($current_packs) {

	    return array('aqualine_fa5_icons', 'aqualine_theme_icons');
	}

	add_filter('fw:option_type:icon-v2:filter_packs', 'aqualine_fw_custom_packs');	
}
